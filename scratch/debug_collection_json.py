...
source_file = r"c:\Users\27916\Downloads\在韩留学生服务社区\scratch\collection_rows.json"

with open(source_file, "r", encoding="utf-8") as f:
    data = json.load(f)

print("Keys in collection_rows.json:")
...
if "block" in record_map:
    ...
    print(f"\nNumber of blocks in collection_rows: {len(block_map)}")
